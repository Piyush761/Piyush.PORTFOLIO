...
<body>
  ...
  <div class="container">
    <section id="about">
      <h2>About Me</h2>
      <div class="profile">
        <img src="Piyush.jpg" alt="Profile Image">
    ...
    <section id="certificate">
      ...
      <div class="certificate">
        <a href="https://via.placeholder.com/600x400" target="_blank">
          <img src="card.jpg/600x400" alt="Score Card Certificate">
        </a>
      </div>
    </section>
    <section id="contact">
      <h2>Contact</h2>
      <p>Get in touch via email at <a href="piyushsaini445@gmail.com" style="color: var(--primary-color);">piyushsaini445@gmail.com</a> or connect on <a href="https://www.linkedin.com/in/piyush-saini-387516330?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" style="color: var(--primary-color);">LinkedIn</a>.</p>
    </section>
  </div>
  <footer>
